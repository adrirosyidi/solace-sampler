...
public class SolaceSamplerSubscriberQueue extends AbstractJavaSamplerClient {
    ...
    private static final String ARG5_TAG = "Queue";

    private static final Logger LOGGER = LoggerFactory.getLogger(SolaceSamplerSubscriberQueue.class);
    ...
    public Arguments getDefaultParameters() {
        ...
        defaultParameters.addArgument(ARG5_TAG, "queue");
